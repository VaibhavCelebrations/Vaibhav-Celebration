...
function VerifyEmailContent() {
  ...
  if (status === "success") {
    return (
      <div className="text-center py-4">
        ...
        <h3 className="font-display text-xl font-bold text-charcoal mb-2">Email Verified</h3>
        <p className="text-sm text-text-muted">Thank you — your email address has been confirmed.</p>
      </div>
    );
  }
  ...
  return (
    <div className="text-center py-4">
      ...
      <p className="text-sm text-text-muted">{error || "This verification link is invalid or missing."}</p>
    </div>
  );
}
    ...
    <>
      ...
      <main className="pt-28 md:pt-36 pb-16 md:pb-24 bg-cream min-h-screen">
        <div className="max-w-4xl mx-auto px-5 md:px-10">
          <ScrollReveal>
            <SectionHeader eyebrow="Account" title="Email Verification" description="" />
          </ScrollReveal>
