...
export function WhatsAppFAB({ phone }: WhatsAppFABProps) {
  ...
  return (
    <a
      ...
      className={`fixed right-5 md:right-6 z-[100] flex items-center justify-center gap-2 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 ${bottomClass} p-3 md:px-5 md:py-3 group`}
    >
