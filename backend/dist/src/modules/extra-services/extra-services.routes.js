...
const schema = zod_1.z.object({
    ...
    slug: zod_1.z.string().min(1).optional().nullable(),
    ...
    pricingMode: zod_1.z
        ...
        .optional()
        .nullable(),
    locationScope: zod_1.z.enum(["ALL", "JAIPUR_ONLY", "OUTSIDE_JAIPUR"]).optional(),
    choiceCount: zod_1.z.number().int().min(1).optional().nullable(),
});
