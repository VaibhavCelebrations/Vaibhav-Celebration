    ...
    for (const def of galleryDefs) {
        const image = await prisma.galleryImage.create({
            data: {
                ...
                ctaType: def.themeId ? client_1.GalleryCtaType.THEME : client_1.GalleryCtaType.NONE,
    ...
    const metadataPages = [
        {
            ...
            metaDescription: "One Theme. Every Detail. Beautifully Celebrated — customized kids birthday celebrations, themed experiences, and personalized return gifts in Jaipur.",
            ...
            faqItems: [
                {
                    ...
                    answer: "Registration helps us plan capacity — please register online.",
                },
            ],
