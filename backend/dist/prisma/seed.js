...
async function main() {
  ...
  await prisma.bookingCapacityRule.createMany({
    data: [
      {
        scope: client_1.CapacityScope.GLOBAL_DEFAULT,
        maxBookingsPerDay: 2,
        isBlocked: false,
      },
      {
  ...
  const standardPkg = await prisma.package.create({
    data: {
      ...
      displayOrder: 1,
      description:
        "Perfect for intimate celebrations with essential décor and coordination.",
    },
  });
  const premiumPkg = await prisma.package.create({
    data: {
      ...
      displayOrder: 2,
      description:
        "Most loved for memorable celebrations with themed décor and personalized touches.",
    },
  });
  const luxPkg = await prisma.package.create({
    data: {
      ...
      displayOrder: 3,
      description:
        "Grand, unforgettable experiences with premium décor, activities, and full support.",
    },
  });
  ...
  const royalTheme = await prisma.theme.create({
    data: {
      ...
      seoDescription:
        "Experience regal wedding décor with our Royal Mandap theme at Vaibhav Farmhouse.",
    },
  });
  const gardenTheme = await prisma.theme.create({
    data: {
      ...
      seoDescription:
        "Dreamy outdoor wedding theme with pastel florals and garden arches.",
    },
  });
  const minimalTheme = await prisma.theme.create({
    data: {
      ...
      seoDescription:
        "Contemporary minimal wedding décor with clean lines and neutral tones.",
    },
  });
  ...
  const sampleAssetDefs = [
    {
      type: client_1.SampleAssetType.DIGITAL_INVITE,
      title: "Digital Wedding Invite",
      mediaId: sampleInviteMedia.id,
    },
    {
      type: client_1.SampleAssetType.VIDEO_INVITE,
      title: "Video Invite Preview",
      mediaId: royalMedia.id,
    },
    {
      type: client_1.SampleAssetType.PARENT_PARTY_BRIEF,
      title: "Parent Party Brief",
      mediaId: gardenMedia.id,
    },
    {
      type: client_1.SampleAssetType.COUNTDOWN_CARD,
      title: "Countdown Card",
      mediaId: minimalMedia.id,
    },
    {
      type: client_1.SampleAssetType.ACTIVITY_KIT,
      title: "Kids Activity Kit",
      mediaId: gallery1Media.id,
    },
    {
      type: client_1.SampleAssetType.RETURN_GIFT_PREVIEW,
      title: "Return Gift Preview",
      mediaId: gallery2Media.id,
    },
    {
      type: client_1.SampleAssetType.OTHER,
  ...
  // ── Gallery ──────────────────────────────────────────────────────────────────
  const tagWedding = await prisma.galleryTag.create({
    data: { name: "Wedding" },
  });
  const tagReception = await prisma.galleryTag.create({
    data: { name: "Reception" },
  });
  const tagOutdoor = await prisma.galleryTag.create({
    data: { name: "Outdoor" },
  });
  const tagMandap = await prisma.galleryTag.create({
    data: { name: "Mandap" },
  });
  ...
  const faqData = [
    {
      ...
      answer:
        "We recommend booking at least 3–6 months ahead for peak wedding season (Oct–Feb).",
    },
    {
      category: "Booking",
      question: "Can I visit the venue before booking?",
      answer:
        "Yes! Schedule a free consultation or attend our monthly Open Day events.",
    },
    {
      category: "Packages",
      question: "What is included in the base package price?",
      answer:
        "Each package includes venue access, base décor, seating, and event coordination.",
    },
    {
      category: "Packages",
      question: "Can I upgrade my package after booking?",
      answer:
        "Yes, upgrades are possible subject to availability. Contact our operations team.",
    },
    {
      category: "Themes",
      question: "Can themes be customized?",
      answer:
        "Absolutely. Our design team can tailor colors, florals, and layout to match your vision.",
    },
    {
      category: "Venue",
      question: "What is the venue capacity?",
      answer:
        "Our farmhouse accommodates 50–350 guests depending on the package and setup.",
    },
    {
      category: "Venue",
    ...
    },
    {
      ...
      answer:
        "40% advance on booking confirmation, 40% two weeks before event, 20% on event day.",
    },
    {
      category: "Payments",
    ...
    },
    {
      ...
      answer:
        "Catering is available as an add-on. We partner with trusted vendors for multi-cuisine menus.",
    },
  ];
  ...
  const metadataPages = [
    {
      pageKey: "home",
      metaTitle:
        "Vaibhav Celebrations | Premium Farmhouse Weddings in Jaipur NCR",
      metaDescription:
        "Premium farmhouse wedding venue near Surajkund, Faridabad. Book your dream celebration today.",
    ...
    },
    {
      ...
      metaDescription:
        "Explore Royal Mandap, Garden Bloom, and Minimal Elegance wedding themes.",
    ...
    },
    {
      ...
      metaDescription:
        "Standard, Premium, and Lux celebration packages for unforgettable birthdays.",
    ...
    },
    {
      ...
      metaDescription:
        "Browse real wedding photos from Vaibhav Celebrations farmhouse venue.",
    ...
    },
    {
      ...
      metaDescription:
        "Schedule a consultation or visit our farmhouse near Surajkund, Faridabad.",
    ...
    },
    {
      ...
      metaDescription:
        "Regal maroon and gold wedding décor with ornate mandap setup.",
    ...
    },
    {
      ...
      metaDescription:
        "Pastel florals and garden arches for dreamy outdoor weddings.",
    ...
    },
    {
      ...
      metaDescription:
        "Tips, trends, and inspiration for planning your perfect wedding.",
  ...
  const { defaultPageSections } = await Promise.resolve().then(() =>
    __importStar(require("../src/modules/pages/pages.service")),
  );
  ...
  await prisma.popup.create({
    data: {
      ...
      placements: [
        client_1.PopupPlacement.HOMEPAGE,
        client_1.PopupPlacement.THEMES_PAGE,
        client_1.PopupPlacement.PACKAGES_PAGE,
      ],
