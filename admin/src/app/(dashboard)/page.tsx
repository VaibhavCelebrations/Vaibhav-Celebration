              ...
              <tbody>
                {RECENT_BOOKINGS.map((b, i) => (
                  <tr
                    key={b.id}
                    style={{
                      backgroundColor: i % 2 === 0 ? "#fff" : "var(--color-surface)",
                      transition: "background-color 150ms ease",
                    }}
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLTableRowElement).style.backgroundColor = "var(--color-blush-light)";
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLTableRowElement).style.backgroundColor = i % 2 === 0 ? "#fff" : "var(--color-surface)";
                    }}
                  >
